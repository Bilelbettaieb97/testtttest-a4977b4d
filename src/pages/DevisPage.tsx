...
const offers = [
  {
    ...
    features: [
      { text: "Site vitrine professionnel", highlight: false, bold: false },
      { text: "Design sur-mesure responsive", highlight: false, bold: false },
      { text: "Optimisation SEO de base", highlight: false, bold: false },
