        ...
        <section className="py-20 bg-card border-y border-border">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">Des campagnes qui ont généré des résultats exceptionnels</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="rounded-2xl border border-border overflow-hidden bg-background hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <span className="text-xs font-medium text-amber-600 bg-amber-100 dark:bg-amber-900/30 px-2 py-1 rounded-full">Google Ads</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">Formation en ligne</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Campagnes Search et Display pour un organisme de formation professionnelle.
                  </p>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                    <div>
                      <p className="text-2xl font-bold text-amber-600">ROAS 6.2</p>
                      <p className="text-xs text-muted-foreground">Retour invest.</p>
                    </div>
                    <div>
              ...
              <div className="rounded-2xl border border-border overflow-hidden bg-background hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <span className="text-xs font-medium text-blue-600 bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded-full">Meta Ads</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">Marque Cosmétique</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Stratégie Facebook et Instagram Ads pour le lancement d'une gamme de soins.
                  </p>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                    <div>
                      <p className="text-2xl font-bold text-blue-600">+320%</p>
                      <p className="text-xs text-muted-foreground">Ventes online</p>
                    </div>
                    <div>
            ...
            <div className="text-center mt-10">
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 font-medium">
