  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://convertilab.fr/services/seo" />
      </Helmet>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* Case Study 1 */}
              <div className="rounded-2xl border border-border overflow-hidden bg-card hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <span className="text-xs font-medium text-emerald-600 bg-emerald-100 dark:bg-emerald-900/30 px-2 py-1 rounded-full">SEO Local</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">Clinique Dentaire Paris</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Stratégie SEO locale complète pour dominer les recherches "dentiste Paris".
                  </p>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                    <div>
                      <p className="text-2xl font-bold text-emerald-600">#1</p>
                      <p className="text-xs text-muted-foreground">Position Google</p>
                    </div>
                    <div>
              ...
              <div className="rounded-2xl border border-border overflow-hidden bg-card hover:shadow-lg transition-shadow">
                <div className="h-48 bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center">
                  <ClipboardCheck className="w-16 h-16 text-white/80" />
                </div>
                <div className="p-6">
                  <span className="text-xs font-medium text-cyan-600 bg-cyan-100 dark:bg-cyan-900/30 px-2 py-1 rounded-full">Audit + Optimisation</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">E-commerce Mode</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Audit technique et stratégie de contenu pour un site e-commerce fashion.
                  </p>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                    <div>
                      <p className="text-2xl font-bold text-cyan-600">+185%</p>
                      <p className="text-xs text-muted-foreground">Ventes organiques</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-cyan-600">6 mois</p>
                      <p className="text-xs text-muted-foreground">Pour résultats</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center mt-10">
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-700 font-medium">
                Voir toutes nos réussites SEO
