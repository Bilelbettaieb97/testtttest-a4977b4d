        ...
        <section className="py-20 bg-card border-y border-border">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">Des créations qui ont transformé l'image de nos clients</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="rounded-2xl border border-border overflow-hidden bg-background hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <span className="text-xs font-medium text-pink-600 bg-pink-100 dark:bg-pink-900/30 px-2 py-1 rounded-full">Identité Visuelle</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">Restaurant Gastronomique</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Refonte complète de l'identité visuelle : logo, carte, signalétique et packaging.
                  </p>
              ...
              <div className="rounded-2xl border border-border overflow-hidden bg-background hover:shadow-lg transition-shadow">
                <div className="h-48 bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center">
                  <PenTool className="w-16 h-16 text-white/80" />
                </div>
                <div className="p-6">
                  <span className="text-xs font-medium text-purple-600 bg-purple-100 dark:bg-purple-900/30 px-2 py-1 rounded-full">Design UI/UX</span>
                  <h3 className="text-xl font-bold text-foreground mt-3 mb-2">Application FinTech</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Refonte UX complète d'une application de gestion financière mobile.
                  </p>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                    <div>
                      <p className="text-2xl font-bold text-purple-600">-60%</p>
                      <p className="text-xs text-muted-foreground">Taux rebond</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-purple-600">4.8/5</p>
                      <p className="text-xs text-muted-foreground">Note App Store</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center mt-10">
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-pink-600 hover:text-pink-700 font-medium">
