...
const ContactPage = () => {
  const breadcrumbItems = [
    ...
    { name: "Contact", url: "https://convertilab.fr/contact" }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://convertilab.fr/contact" />
        ...
        <meta property="og:url" content="https://convertilab.fr/contact" />
