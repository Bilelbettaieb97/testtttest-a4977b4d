            ...
            <div className="lg:col-span-2 order-1 lg:order-2 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-lg border border-slate-200 dark:border-slate-800">
                <div className="space-y-4">
                  <a href="mailto:contact@convertilab.fr" className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white text-sm">contact@convertilab.fr</p>
                  ...
                  <a href="tel:0783494709" className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white text-sm">07 83 49 47 09</p>
