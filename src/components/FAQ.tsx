      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg border-0">
            <CardContent className="p-6 sm:p-8">
              <Accordion type="single" collapsible className="w-full">
                {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border-gray-200">
          ...
          <div className="text-center mt-8 sm:mt-12 p-4 sm:p-8 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl text-white">
            <h3 className="text-xl sm:text-3xl font-bold mb-3 sm:mb-4">D'autres questions ? 
Parlons-en !</h3>
